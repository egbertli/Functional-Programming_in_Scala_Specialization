...
object LogSQL {
  ...
  def main(args: Array[String]) {
    ...
    val conf = new SparkConf().setAppName("LogSQL").setMaster("local[*]").set("spark.sql.warehouse.dir", "/Users/yixuan-li/Documents/github/Functional-Programming_in_Scala_Specialization/Spark-Streaming/ApacheAccessLog")
    ...
    // Kick it off
    ssc.checkpoint("/Usersa/yixuan-li/Documents/github/Functional-Programming_in_Scala_Specialization/Spark-Streaming/ApacheAccessLog/checkpoint/")
    ssc.start()
